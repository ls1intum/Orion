...
interface OrionRouter {
     ...
     * leading to the exercise for students, the editor for instructors or the assessment dashboard for tutors.
     *
     * If no Artemis exercise is opened, the configured base URL is returned
     *
     * @return The URL to the exercise in the Artemis webapp or the base URL if no exercise is opened
     */
